...
document.getElementById("MeleeButton").addEventListener("touchstart", MeleeButtonDown, {passive: true});
document.getElementById("MeleeButton").addEventListener("touchend", MeleeButtonUp, {passive: true});
